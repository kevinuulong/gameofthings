...
io.on('connection', function(socket){
    ...
    io.sockets.connected[socket.id].emit('reloadCheck')
    ...
    socket.on('startGame', function(data){
        var thing = randomNoRepeats(things); //things[Math.floor(Math.random()*things.length)];
            responses = [];
